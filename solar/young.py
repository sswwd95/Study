...
# 원하는 열만 가져오기
dataset = pd.read_csv('../solar/train/train.csv', index_col=None, header=0)
# print(dataset.shape)
...
subfile = pd.read_csv('./solar/csv/sample_submission.csv')
...
for q in qlist:
    ...
    filepath = '../solar/check/solar0122_{epoch:02d}_{val_loss:.4f}.hdf5'
...
subfile.to_csv('./solar/csv/sub_conv2d_young.csv', index=False)