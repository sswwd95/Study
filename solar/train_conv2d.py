...
x = x.reshape(52417,48,6,1)
y = y.reshape(52417,1,2,1)

print("x.shape : ", x.shape) #(52129*7,1, 48, 6)
print(x)
print(y)
...
x_pred=X_test.reshape(81,48,6,1)

print(x_pred.shape) #(1,81,48,6)
...
model = Sequential()
model.add(Conv2D(32,2,activation='relu', input_shape=(48,6,1)))
...
y_pred.to_csv('./solar/csv/submission_1.csv', sep=',')
