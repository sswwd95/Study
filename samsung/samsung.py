...
# print(dataset)
# print(dataset.shape) #(658, 5, 5)


# x = dataset[:-1,:,:-1]
# print(x.shape) #(657, 5, 4)
# y = dataset[1:,-1:,-1:]
...
# x_pred = x_pred.reshape(x_pred.shape[0],5,4)
# print(x.shape)
# print(x_pred)
...
# np.save('../data/npy/samsung.npy',arr=[x_train, x_test, y_train, y_test,x_pred])
