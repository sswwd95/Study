...
dense2 = Dense(25, activation='relu')(dense2)
# 합치기
merge1 = concatenate([dense1, dense2])
middle1 = Dense(200, activation='relu')(merge1)     
middle1 = Dense(100, activation='relu')(middle1)
middle1 = Dense(50, activation='relu')(middle1)
middle1 = Dense(25, activation='relu')(middle1)
...
pred = model.predict([x_pred,x1_pred])
print('1월 18일(시가) : ', pred[0])
print('1월 19일(시가) : ', pred[1])
