...
for i in scaler:
    pipe=Pipeline([('mms', i), ('a', RandomForestClassifier())])
    for j in search:
...
# print(results) 
'''
# MinMaxScaler() <class 'sklearn.model_selection._search.RandomizedSearchCV'> : 1.0
# MinMaxScaler() <class 'sklearn.model_selection._search.GridSearchCV'> : 1.0
# StandardScaler() <class 'sklearn.model_selection._search.RandomizedSearchCV'> : 1.0
# StandardScaler() <class 'sklearn.model_selection._search.GridSearchCV'> : 1.0
