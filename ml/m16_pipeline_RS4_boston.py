...
for i in scaler:
    pipe=Pipeline([('mms', i), ('a', RandomForestRegressor())])
    for j in search:
...
# print(results) 
'''
# MinMaxScaler() <class 'sklearn.model_selection._search.RandomizedSearchCV'> : 0.8986859253942985
# MinMaxScaler() <class 'sklearn.model_selection._search.GridSearchCV'> : 0.9040762158133058
# StandardScaler() <class 'sklearn.model_selection._search.RandomizedSearchCV'> : 0.9037846460286673
# StandardScaler() <class 'sklearn.model_selection._search.GridSearchCV'> : 0.9011377123666596
