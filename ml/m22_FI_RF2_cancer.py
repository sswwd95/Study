...
df1 = df.drop(['smoothness error', 'symmetry error', 'compactness error', 'mean symmetry', 'fractal dimension error', 'concave points error', 'mean fractal dimension', 'texture error', 'concavity error', 'worst fractal dimension'], axis=1)
df2 = df.to_numpy()
print(df1.shape)
