...
mc = ModelCheckpoint('../data/lotte/mc/lotte_b4_hwang.h5',save_best_only=True, verbose=1)
...
model.compile(loss='categorical_crossentropy',
            ...
            metrics=['acc'])
learning_history = model.fit_generator (train_generator,epochs=500, steps_per_epoch= len(x_train) / 32,
    validation_data=valid_generator, callbacks=[early_stopping,lr,mc])

# predict
model.load_weights('../data/lotte/mc/lotte_b4_hwang.h5')
...
sub.to_csv('../data/lotte/answer_hwang.csv',index=False)
